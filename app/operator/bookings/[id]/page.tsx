      ...
      <div className="grid gap-8 lg:grid-cols-3">
        ...
        <div className="lg:col-span-2">
          ...
          <Card className="mb-6 p-6">
            <h2 className="mb-4 text-xl font-semibold">Booking Period</h2>
          ...
          {/* Booking Terms */}
          <Card className="mb-6 p-6">
            <h2 className="mb-4 text-xl font-semibold">Booking Terms</h2>
        ...
        <div>
          ...
          {/* Owner Info */}
          <Card className="mb-6 p-6">
            <h2 className="mb-4 text-xl font-semibold">Vessel Owner</h2>
            <p className="font-medium">
              {booking.vessel.owner.name || booking.vessel.owner.email}
            </p>
            <p className="text-sm text-gray-600">{booking.vessel.owner.email}</p>
          </Card>

          {/* Actions */}
          <BookingActions booking={booking} userRole="OPERATOR" />
        </div>
      </div>
    </main>
  );
